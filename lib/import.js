...
export class Imports { 
    ...
    save(){
        ...
        Cookies.set('BGColor', this.background.TargetColor) // array
        Cookies.set('Map', this.debug.Map) // number
        this.debug.add(Cookies.get('Map'))
    ...
    load(){
        ...
        var BGColor = JSON.parse("["+Cookies.get('BGColor')+"]") // array
        this.background.TargetColor = BGColor

        var Mape = 0
        this.debug.map= parseInt(Cookies.get['Map'])
