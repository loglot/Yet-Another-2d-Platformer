...
export class Player{
    ...
    colide(){
        ...
        for(let x = xRange[0];x < xRange[1]; x++){
            ...
            for(let y = yRange[0];y < yRange[1]; y++){
                ...
                if(colide[0]&& (colide[1]==1 || colide[1]==4)){
                    this.x=x*50+75
                    this.velX=0
    ...
    deathAnimate(){
        ...
        for(let i = 0; i<8; i++){
            ...
            this.deathOrbs[i].x=this.deathOrbs[i].x+xChange*speed
            this.deathOrbs[i].y=this.deathOrbs[i].y+yChange*speed
        }
        ...
        this.game.debug.add(this.deathOrbs[0].x-this.x)
    }
