...
export class Player{
    ...
    //     if(
    //         this.x+50>Shape2.X&&
    //         this.x<Shape2.X+Shape2.W&&
    //         this.x+100>Shape2.Y&&
    //         this.x<Shape2.Y+Shape2.H
    //     ){
    //         return(true)
    ...
    collisionCheck(part, x, y) {
        ...
        //     ) {
                ...
                this.playerHitbox[part].x+this.playerHitbox[part].width>x*50&&
                this.playerHitbox[part].x<x*50+50&&
                this.playerHitbox[part].x+this.playerHitbox[part].height>y*50&&
                this.playerHitbox[part].x<y*50+50
            ){
