...
export class Held {
    ...
    makeImg(){
        switch(this.selected) {
            case -1: 
            this.image.src = 'assets/images/warn.png'
            break;
            case 0: 
            this.image.src = this.game.keys.Enabled.get("hook").src
            break;
            case 1: 
            this.image.src = this.game.keys.Enabled.get("pickaxe").src;
            break;
            case 2: 
            this.image.src = this.game.keys.Enabled.get("bazooka").src;
            break;
            case 3: 
            this.image.src = this.game.keys.Enabled.get("shotgun").src;
            break;
            case 4: 
            this.image.src = this.game.keys.Enabled.get("dash").src;
            break;
            case 5: 
            this.image.src = this.game.keys.Enabled.get("portal").src;
            break;
        }
        this.imageA = 5
