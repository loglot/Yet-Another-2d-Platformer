export class Hook {
    ...
    tick(){
        this.x[0]=(this.x[0]+(this.game.player.x+this.game.held.trajectory.x*60))/2
        this.y[0]=(this.y[0]+(this.game.player.y+this.game.held.trajectory.y*100))/2
        ...
        if(this.anchored){
            ...
            this.game.player.velX = this.game.player.velX - ((this.x[0] - (this.x[1])) / 70)
            this.game.player.velY = this.game.player.velY - ((this.y[0] - (this.y[1])) / 230)+.5
        }
