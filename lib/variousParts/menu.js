...
export class Menu{
    ...
    tick(){
        ...
        if(this.game.state=="Settings"){
            ...
            this.rotation=(this.rotation*6+1)/7
            this.alpha=(this.alpha*6+this.alphaTarget)/7
    ...
    settings(){
        ...
        for(let i = 0; i < this.Catagory.length; i++){
            ...
            this.game.draw.Text(this.Catagory[i].title + " : " + this.Catagory[i].state, ((310-i*200)-(this.CatagoryY*2 ))+0,(ything + (((ything)-450)*((ything)-450))/40)+280,"black","white",ctx,80 + i*20 +(this.CatagoryY/5 )-4)
